    ...
    <div className="privacy-policy-container">
      ...
      <div className="container___">
        ...
        <p>
          ...
          experience purchasing from our webstore, EShopp.com.
        </p>
        <p>
        ...
        <p>
          You (“Customer”) may place orders for Products with EShopp
          ...
          agreed to or set forth in writing by EShopp, any term or
        ...
        <h2>Orders</h2>
        <p>
          All orders are subject to EShopp's acceptance. This means
          EShopp may, for any reason, refuse to accept or may cancel or
          ...
          cancel an order after you have already been charged, EShopp
        ...
        <p>
          ...
          and it is accepted by EShopp. Prices for products displayed on
          ...
          website may differ from those in stores that stock EShopp
          products, as these stores are independent of EShopp.
          EShopp reserves the right to amend pricing for any pricing
          ...
          submitted an online order, EShopp will notify you of the error
        ...
        <p>
          ...
          EShopp reserves the right to change or discontinue such offers
          at any time.
        </p>
        <h2>Taxes</h2>
        <p>
          The prices quoted for the products sold hereunder include applicable
          taxes. Customer shall pay, and reimburse EShopp if it pays, any
          taxes, except for those based on EShopp's income.
        </p>
        <h2>Payment</h2>
        <p>
        ...
        <p>
          ...
          process. Any timeframe provided by EShopp for when the
          ...
          are beyond our control. EShopp cannot be held liable for late
        ...
        <h2>Returns</h2>
        <p>
          Once an order has been placed and accepted by EShopp, customer
          may not cancel such accepted order without EShopp’s prior
          ...
          expenses. The product(s) must be returned to EShopp within
        ...
        <p>
          ...
          indemnify and hold EShopp harmless from and against any and all
        ...
        <p style={{ fontWeight: "500" }}>EShopp</p>
        <p style={{ fontWeight: "500" }}>123 Main Street, City, Country</p>
        <p style={{ fontWeight: "500" }}>
          Email:{" "}
          <span style={{ fontWeight: "400" }}>info@EShopp.com</span>
        </p>
      </div>
    </div>
  );
