  ...
  return (
    <div className="terms-container">
      ...
      <div className="terms-content">
        <p>
          Thank you for shopping with EShopp! We appreciate your business
        ...
        <p>
          ...
          agreed to in writing by EShopp.
        </p>
        <h2>Orders</h2>
        <p>
          All orders are subject to EShopp's acceptance. We may refuse to
        ...
        <p>
          ...
          EShopp. Prices displayed on the website exclude shipping
          ...
          from those in physical stores that stock EShopp products. We
        ...
        <p>
          ...
          taxes, except for those based on EShopp's income. If
          EShopp is required to collect and pay taxes on Customer's
        ...
        <p>
          ...
          order without EShopp's written consent. You may return products
        ...
        <p>
          You agree to indemnify and hold EShopp harmless from any
          claims, costs, proceedings, losses, or demands arising from your
          breach of these Terms or anyone using your account.
        </p>
        <h2>Entire Agreement</h2>
        <p>
          These Terms constitute the entire agreement between EShopp and
