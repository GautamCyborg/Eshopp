...
const slides = [
  {
    ...
    quote:
      "Unleash Your Shopping Desires with EShopp",
    saleText:
      "Discover, Shop, Smile:Your One Stop Shopping Destination: EShopp",
    productText: "Shop Now",
  },
  {
    image: require("../../Image/Cricket-wepon/01.jpg"),
    quote:
      "Enjoy secure transactions and swift delivery, making every purchase a breeze",
    saleText: "Discover an online shopping paradise at eShopp. Explore a vast selection of products, from fashion to electronics.",
    productText: "Explore",
  },
];
