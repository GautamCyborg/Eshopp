 ...
 const footSocial = [
   {
     ...
     path: "https://www.instagram.com/c__borg/",
   },
   {
     id: 2,
     icon: <TwitterIcon className="twitter_icon" fontSize="large" />,
     path: "https://twitter.com/GautamSinghJad1",
   },
   {
     id: 3,
   ...
   },
   {
     ...
     path: "https://www.linkedin.com/in/gautam-singh-jadon-93062519b/",
   },
 ];
            ...
            <div className="foot_about foot1">
              <div className="foot_logo">
                <Link to="/" style={{ textDecoration: "none" }}>
                  <img
                    src={require("../../../Image/Footer/eshopplogo.png")}
          ...
          <div className="container_Footer">
            <div className="sub_footer_wrapper">
              ...
              <div className="foot_copyright">
                <p>
                  &copy; {currYear} | EShopp, All Rights Reserved.
                </p>
              </div>
            </div>
          </div>
